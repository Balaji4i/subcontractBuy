...
public class GeneralUtils {
    ...
    public void displayMessage(String str, String type) {
        ...
        if (type.equalsIgnoreCase("")) {
            fm =
 FacesMessageUtils.getConfirmationMessage(new FacesMessage(str));
        }
    ...
    public String clearViewCrieteria(String Iterator) {
        try {
            ViewObject custSearchVO =
                ADFUtils.findIterator(Iterator).getViewObject();
            ViewCriteriaManager custVcman =
                custSearchVO.getViewCriteriaManager();
    ...
    public void tableFilterRefresh(RichTable getTableMethod) {
        FilterableQueryDescriptor queryDescriptor =
            (FilterableQueryDescriptor)getTableMethod.getFilterModel();
        if (queryDescriptor != null &&
            queryDescriptor.getFilterCriteria() != null) {
            queryDescriptor.getFilterCriteria().clear();
            getTableMethod.queueEvent(new QueryEvent(getTableMethod,
                                                     queryDescriptor));
        }
    }
